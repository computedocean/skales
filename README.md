...
<p align="center">
 ...
 <p>
    <a href="https://github.com/skalesapp/skales/releases/latest"><img src="https://img.shields.io/badge/version-12.6.1-10b981?style=flat-square" alt="Version 12.6.1" /></a>
...
12.6.1 tidies a hundred releases of provider settings into a switchable grid with capability badges (Tencent Hunyuan joins the list), lets agent teams take turns on a single graphics card, teaches the scheduler to survive sleep, and connects Qdrant or ChromaDB as retrieval backends.
